    ...
    public static Bitmap downloadBitmap(String url) {
        ...
        try {
            ...
            if (statusCode != HttpStatus.SC_OK) {
                CLog.i(LOG_TAG+" Error " + statusCode + " while retrieving bitmap from " + url);
                return null;
            }
            ...
            getRequest.abort();
            CLog.i(LOG_TAG+" I/O error while retrieving bitmap from " + url+" "+e);
        } catch (IllegalStateException e) {
            getRequest.abort();
            CLog.i(LOG_TAG+" Incorrect URL: " + url);
        } catch (Exception e) {
            getRequest.abort();
            CLog.i(LOG_TAG+" Error while retrieving bitmap from " + url+" "+e);
        } finally {
